...
class DCASE2020LTSPTrainer:
    def __init__(self, config: dict[str, Any]) -> None:
        ...
        self.load_path: str = config.get("load_path", "")
    ...
    def train(self) -> None:
        ...
        checkpoint = torch.load(self.load_path, weights_only=True)
        ...
        for epoch in range(start_epoch + 1, self.epoch + 1):
            ...
            for batch in p_bar:
                ...
                for train_loss_key in self.train_loss_keys:
                    ...
                    p_bar_log_dict[train_loss_key] = f"{value:.3e}"
    ...
    def test(self, epoch: int = 0, model=None) -> None:
        ...
        data_for_test_metrics["file_path"] = None
